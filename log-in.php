...
<head>
	...
	<style type="text/css">
		...
		#name {position: relative;margin-left: 92.5%;}
...
<body>
	<div id="fix">
		...
		<div class="controls">
			<form action="log-in.php" method="POST">
	   			<input type="range" name="price" id="price" min=1 max=100000 style="width: 70%;margin-left: 10%;" onchange="var price=document.getElementById('price');var display=document.getElementById('p');display.textContent=price.value;">
	   				<b>Price</b>
	   				<span id="p">
	   			...
	   			<?php 
	   				...
	   				while ($row=mysqli_fetch_array($result)) {
	   					foreach($row as $key=>$value) 
						{
							...
							{	
								echo "<p><input type='radio' name='brand' value='".$value."'>".$value."</input></p>";
							}
						}
	   				}
	   			?>
	   			<p><input type="range" name="rating" id="rating" min=1 max=5 style="width: 70%;margin-left: 25%;" onchange="var rating=document.getElementById('rating');var display=document.getElementById('p1');display.textContent=rating.value;">
	   				<b>Rating</b>
	   				<span id="p1">
	   					<script type="text/javascript">var display=document.getElementById('p1');display.textContent=rating.value;</script>
	   				</span>
	   			</input></p>
	   			<p><input type="submit" name="sub" value="Apply"></input></p>
	   		</form>
		</div>
	</div>
	<?php
